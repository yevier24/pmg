 ...
 */
final class Version20191006180801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda DROP INDEX UNIQ_C0C6E53E5E237E06, ADD INDEX IDX_C0C6E53E5E237E06 (name)');
        $this->addSql('ALTER TABLE tienda CHANGE name name INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda DROP INDEX IDX_C0C6E53E5E237E06, ADD UNIQUE INDEX UNIQ_C0C6E53E5E237E06 (name)');
        $this->addSql('ALTER TABLE tienda CHANGE name name INT DEFAULT NULL');
