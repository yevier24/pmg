 ...
 */
final class Version20191006205359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda ADD CONSTRAINT FK_C0C6E53EB8D75A50 FOREIGN KEY (empresa) REFERENCES empresa (id)');
        $this->addSql('ALTER TABLE tienda ADD CONSTRAINT FK_C0C6E53EA786041E FOREIGN KEY (zona) REFERENCES zona (id)');
        $this->addSql('CREATE INDEX IDX_C0C6E53EB8D75A50 ON tienda (empresa)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda DROP FOREIGN KEY FK_C0C6E53EB8D75A50');
        $this->addSql('ALTER TABLE tienda DROP FOREIGN KEY FK_C0C6E53EA786041E');
        $this->addSql('DROP INDEX IDX_C0C6E53EB8D75A50 ON tienda');
        $this->addSql('DROP INDEX IDX_C0C6E53EA786041E ON tienda');
        $this->addSql('ALTER TABLE tienda CHANGE empresa empresa VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE zona zona VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
