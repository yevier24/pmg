 ...
 */
final class Version20191008225349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trabajador DROP INDEX UNIQ_42157CDF4D9192F8, ADD INDEX IDX_42157CDF4D9192F8 (supervisor)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda CHANGE empresa empresa INT DEFAULT NULL, CHANGE zona zona INT DEFAULT NULL');
        $this->addSql('ALTER TABLE trabajador DROP INDEX IDX_42157CDF4D9192F8, ADD UNIQUE INDEX UNIQ_42157CDF4D9192F8 (supervisor)');
