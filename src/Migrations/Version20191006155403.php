 ...
 */
final class Version20191006155403 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zona DROP comuna');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zona ADD comuna VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
