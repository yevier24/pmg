 ...
 */
final class Version20191006201000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE zona CHANGE names name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE empresa CHANGE names name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE empresa CHANGE name names VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('ALTER TABLE zona CHANGE name names VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
