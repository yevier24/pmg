 ...
 */
final class Version20191009233045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE carga (id INT AUTO_INCREMENT NOT NULL, columna1 VARCHAR(255) DEFAULT NULL, columna2 VARCHAR(255) DEFAULT NULL, columna3 VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
