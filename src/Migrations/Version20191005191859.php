 ...
 */
final class Version20191005191859 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE zona (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, comuna VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
