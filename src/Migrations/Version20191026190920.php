 ...
 */
final class Version20191026190920 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carga_meta ADD venta NUMERIC(11, 2) DEFAULT NULL, CHANGE cadena cadena INT DEFAULT NULL, CHANGE tienda tienda INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carga_meta DROP venta, CHANGE cadena cadena INT DEFAULT NULL, CHANGE tienda tienda INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tienda CHANGE empresa empresa INT DEFAULT NULL, CHANGE zona zona INT DEFAULT NULL');
