 ...
 */
final class Version20190929050054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trabajador CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE foto foto INT NOT NULL, CHANGE pass pass VARCHAR(255) DEFAULT NULL, CHANGE rut rut VARCHAR(12) DEFAULT NULL');
