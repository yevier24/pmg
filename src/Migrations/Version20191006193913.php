 ...
 */
final class Version20191006193913 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda ADD empresa VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD zona VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP name');
