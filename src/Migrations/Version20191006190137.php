 ...
 */
final class Version20191006190137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda CHANGE empresa empresa INT NOT NULL, CHANGE zona zona INT NOT NULL');
