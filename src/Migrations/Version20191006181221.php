 ...
 */
final class Version20191006181221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tienda ADD zona VARCHAR(255) DEFAULT NULL, CHANGE name name INT DEFAULT NULL');
